...
krenaldi/frontend-nanodegree-mobile-portfolio forked from udacity/frontend-nanodegree-mobile-portfolio
Code
Pull requests 0
Projects 0
Wiki
frontend-nanodegree-mobile-portfolio/views/js/main.js
ce5510c on 10 Nov 2015
@krenaldi krenaldi Updated ReadMe file
@krenaldi
@durant-udacity
572 lines (515 sloc) 24.3 KB
/*
...
function updatePositions() {
  ...
  var positionArray = [];
  var i; 
  //Removes the style change from the loop to prevent forced layouts
  for (i = 0; i < 5; i++) {
